# Escalation: tools/harpp2/objectives/star-swarm-deterministic-probes.md

**Condition:** boundary

**Exact blocker:** test assertion removed or weakened: tests/browser/star-swarm.spec.ts
