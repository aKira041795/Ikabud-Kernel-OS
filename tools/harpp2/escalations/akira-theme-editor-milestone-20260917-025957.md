...
**Exact blocker:** The six browser requirements pass and the authority test passes at its actual module path, but the completion manifest invokes nonexistent tests/theme_read_authority_test.php; correcting tools/harpp2/projects/akira-theme-editor.json or adding that tests-path shim is outside the declared writable scope.
