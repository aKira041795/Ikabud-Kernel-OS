...
**Exact blocker:** refused unsafe evidence command `npx playwright test tests/browser/star-swarm-pixels.spec.ts --grep "collecting the drop grants"`: destroy data
