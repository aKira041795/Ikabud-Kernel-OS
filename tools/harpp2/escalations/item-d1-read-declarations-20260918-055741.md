# Escalation: tools/harpp2/objectives/item-d1-read-declarations.md

**Condition:** boundary

**Exact blocker:** destructive operation introduced in modules/cms-akira/cms-akira-shell/tests/redirect_console_test.php
