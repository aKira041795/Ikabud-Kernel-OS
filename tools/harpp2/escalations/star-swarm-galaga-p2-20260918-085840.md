# Escalation: tools/harpp2/objectives/star-swarm-galaga-p2.md

**Condition:** boundary

**Exact blocker:** outside objective scope: .ai/trust-surface-amendments.json; outside objective scope: tools/harpp2/projects/star-swarm-galaga.json
