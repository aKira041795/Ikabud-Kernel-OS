...
function cms_akira_core_capability_handlers(): array
{
    return [
        ...
        'akira.site.settings.public@1' => 'cac_cap_akira_site_settings_public_1',
        'akira.site.settings.update@1' => 'cac_cap_akira_site_settings_update_1',
        'akira.redirect.list@1' => 'cac_cap_akira_redirect_list_1',
        'akira.redirect.create@1' => 'cac_cap_akira_redirect_create_1',
        'akira.redirect.resolve@1' => 'cac_cap_akira_redirect_resolve_1',
