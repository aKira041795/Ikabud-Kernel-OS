...
function starSwarmTokenDefaults(): array
{
    return [
        ...
        '--ss-moon' => ['fallback' => '#8a8a8a', 'purpose' => 'nursery moon body, neutral grey'],
        '--ss-moon-lit' => ['fallback' => '#b4b4b4', 'purpose' => 'moon lit limb and crater rims'],
        '--ss-moon-crater' => ['fallback' => '#5c5c5c', 'purpose' => 'moon crater interiors'],
