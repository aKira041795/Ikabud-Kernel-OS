...
- Work on the current main working tree. Do NOT run git commit, git push, or git checkout -b. Leave all changes uncommitted for chair review.
- Do NOT touch .ai/** or storage/cms-themes/akira-ark-demo/**.
- Run npm run type-check and npm run build in modules/cms-akira/cms-akira-builder/admin-ui and include the regenerated bundle changes.
- Verify live against tenant 54 exactly as the verification recipe describes, and paste the raw command outputs as evidence.
